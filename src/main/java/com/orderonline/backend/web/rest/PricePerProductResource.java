...
import com.orderonline.backend.service.PricePerProductService;
import com.orderonline.backend.web.rest.errors.BadRequestAlertException;
import com.orderonline.backend.web.rest.util.HeaderUtil;
import com.orderonline.backend.web.rest.util.PaginationUtil;
...
public class PricePerProductResource {
    ...
    private static final String ENTITY_NAME = "orderOnlineBackEndPricePerProduct";
